...
// For example, the syntax highlighting on this site is implemented by spawning a pygmentize process from a Go program.
...
> ls -a -l -h
total 292K
drwxr-xr-x 3 mujibur mujibur 4,0K Sep 25 09:37 .
