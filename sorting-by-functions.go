...
// by casting the original fruits slice to byLength, and then use sort.
// Sort on that typed slice.
func main() {
...
/*
C:/Go/bin/go.exe run sorting-by-functions.go [C:/Users/mujib/go/src/github.com/mujib-programmer/gobyexample]
[kiwi peach banana]
*/
