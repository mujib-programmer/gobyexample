...
// to achieve the same result. This channel-based approach aligns with Go’s ideas of sharing memory
...
func main() {
	...
	// This starts 100 goroutines to issue reads to the state-owning goroutine via the reads channel. E
	// ach read requires constructing a readOp, sending it over the reads channel,
...
/*
C:/Go/bin/go.exe run stateful-goroutines.go [C:/Users/mujib/go/src/github.com/mujib-programmer/gobyexample]
readOps: 95370
writeOps: 9539
*/
