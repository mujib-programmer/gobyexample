...
// like selecting all items that satisfy a given predicate
...
/*
C:/Go/bin/go.exe run collection-functions.go [C:/Users/mujib/go/src/github.com/mujib-programmer/gobyexample]
2
false
true
false
