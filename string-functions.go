...
func main() {
	...
	// for getting the length of a string in bytes and getting a byte by index.
	p("Len: ", len("hello"))
	p("Char:", "hello"[1])
}
...
/*
C:/Go/bin/go.exe run string-functions.go [C:/Users/mujib/go/src/github.com/mujib-programmer/gobyexample]
Contains:  true
Count:  2
HasPrefix:  true
HasSuffix:  true
